...
const getImages = (query) => {
  const KEY = '20264930-7a3ab8d1c4c36335e66ba8cd7';
...
const createSlider = () => {
  ...
  sliders.forEach(slide => {
    ...
    src="${slide}"
    alt="">
    <div class="carousel-caption myAnimation">
        <h5>Programming Just Got Fun</h5>
...
const searchByEnterKey = document.getElementById('search');

searchByEnterKey.addEventListener('keypress', function () {
  document.querySelector('.main').style.display = 'none';
  clearInterval(timer);
  const search = document.getElementById('search');
  getImages(search.value)
